...
define('ember-analyzer/tests/app.lint-test', [], function () {
  ...
  QUnit.test('components/audio-visualizer.js', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/audio-visualizer.js should pass ESLint\n\n34:22 - \'THREE\' is not defined. (no-undef)\n150:18 - \'Tuna\' is not defined. (no-undef)\n232:19 - \'THREE\' is not defined. (no-undef)\n235:19 - \'THREE\' is not defined. (no-undef)\n239:22 - \'THREE\' is not defined. (no-undef)\n251:27 - \'force\' is defined but never used. (no-unused-vars)\n321:22 - \'THREE\' is not defined. (no-undef)\n322:22 - \'THREE\' is not defined. (no-undef)\n323:18 - \'THREE\' is not defined. (no-undef)\n337:26 - \'Uint8Array\' is not defined. (no-undef)\n375:14 - \'Promise\' is not defined. (no-undef)\n375:32 - \'reject\' is defined but never used. (no-unused-vars)\n376:28 - \'BufferLoader\' is not defined. (no-undef)');
  });
